    ...
    <>
      ...
      <div className="max-w-sm mx-auto p-2">
        <AnimatePresence>
          {isVisible && (
            <motion.div
              className="fixed inset-0 p-4 flex max-w-sm mx-auto justify-between h-max items-center z-20 bg-card  bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
            >
              ...
              {!isVisible && (
                <div className="absolute bottom-0 right-[50%] translate-y-[150%] translate-x-[50%]">
                  <motion.div
                    ...
                    variants={ftl ? container : undefined}
                    initial="hidden"
                    animate="show"
                  >
                    <motion.a
        ...
        <div ref={projectsRef}>
          <motion.ol
            className="relative border-l border-card"
            initial={{ opacity: 0 }}
