    ...
    <motion.li className="mb-10 ml-4" initial={{ opacity: 0.75 }} whileInView={{ opacity: 1 }} viewport={{ amount: "all" }}>
      ...
      <div className='z-10 bg-card w-[90%] rounded-md mx-auto p-4 relative -mt-10'>
        ...
        <div className='w-max ml-auto space-x-2'>
          <a href={project.fields.repositoryLink} className="inline-block hover:opacity-75" aria-label='Source code' role="button" tabIndex={0}>
            <VscGithubAlt className="text-rose-500"/>
          </a>
          <a href={project.fields.liveViewLink} className="inline-block hover:opacity-75" aria-label='Live preview' role="button" tabIndex={0}>
